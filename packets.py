...
class StartControlConnectionRequest(ControlMessage):
    ...
    def __init__(
        self,
        framing=gAsynchronousFraming,
        bearer=gAnalogAccessSupported,
        maxChannels=0x0,
        ...
        super().__init__(
            gStartControlConnectionRequest,
            ControlMessage.SIZE + StartControlConnectionRequest.SIZE,
        )
...
class StartControlConnectionReply(ControlMessage):
    ...
    def __init__(
        ...
        super().__init__(
            gStartControlConnectionReply,
            ControlMessage.SIZE + StartControlConnectionReply.SIZE,
...
class StopControlConnectionRequest(ControlMessage):
    ...
    def __init__(self):
        super().__init__(
            gStopControlConnectionRequest,
            ControlMessage.SIZE + StopControlConnectionRequest.SIZE,
        )
        # Reason
...
class StopControlConnectionReply(ControlMessage):
    ...
    def __init__(self, ResultCode=0, ErrorCode=0, packetBytes=None):
        super().__init__(
            gStopControlConnectionReply,
            ControlMessage.SIZE + StopControlConnectionReply.SIZE,
        )
        # Reason
        #   1 (None) - General request to clear control connection
        #   2 (Stop-Protocol) - Can't support peer's version of the protocol
...
class OutgoingCallRequest(ControlMessage):
    ...
    def __init__(self, CallID=2337, CallSerialNumber=2338):
        super().__init__(
            gOutgoingCallRequest, OutgoingCallRequest.SIZE + ControlMessage.SIZE
        )
        self.CallID = CallID
...
class OutgoingCallReply(ControlMessage):
    ...
    def __init__(
        ...
        super().__init__(
            gOutgoingCallReply, OutgoingCallReply.SIZE + ControlMessage.SIZE
        )
        if packetBytes:
            self.CallID = 0
            self.PeersCallID = 0
...
class IncomingCallRequest(ControlMessage):
    ...
    def __init__(
        self,
        CallID=1337,
        CallSerialNumber=1338,
        CallBearerType=gAnalogAccessSupported,
        PhysicalChannelId=0,
        DialedNumberLength=64,
        DialingNumberLength=64,
        DialedNumber=64 * b"A",
        DialingNumber=64 * b"B",
        Subaddress=64 * b"C",
    ):
        super().__init__(
            gIncomingCallRequest, IncomingCallRequest.SIZE + ControlMessage.SIZE
        )
        self.CallID = CallID
        self.CallSerialNumber = CallSerialNumber
...
class IncomingCallReply(ControlMessage):
    ...
    def __init__(
        ...
        PacketTransitDelay=32,
        packetBytes=None,
    ):
        super().__init__(
            gIncomingCallReply,
            IncomingCallReply.SIZE + ControlMessage.SIZE,
            packetBytes=packetBytes,
        )
        if packetBytes:
            self.CallID = 0
...
class IncomingCallConnected(ControlMessage):
    ...
    def __init__(
        ...
        PeerCallID=1337,
        ConnectSpeed=1,
        PacketRecvWindowsSize=64,
        PacketTransmitDelay=0,
        FramingType=gAsynchronousFraming,
        packetBytes=None,
    ):
        super().__init__(
            gIncomingCallConnected,
            IncomingCallConnected.SIZE + ControlMessage.SIZE,
            packetBytes=packetBytes,
        )
...
class CallDisconnectNotify(ControlMessage):
    ...
    def __init__(self):
        super().__init__(
            gCallDisconnectNotify, CallDisconnectNotify.SIZE + ControlMessage.SIZE
        )
        self.CallID = 1337
